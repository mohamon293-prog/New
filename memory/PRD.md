...
### إصلاح شامل للمنصة - Bug Bash ✅ (مكتمل 2025-01-05)
- [x] **إصلاح نظام المصادقة**
  - إصلاح `UserResponse` schema لتضمين `role_level`
  - إصلاح `AuthContext` للتحقق من صلاحيات الأدمن
- [x] **إصلاح إنشاء المنتجات**
  - جعل `name_en` اختياري
  - توليد `slug` تلقائياً
- [x] **إصلاح إدارة الأكواد**
  - إصلاح الاستجابة JSON لإضافة الأكواد
  - إصلاح حساب `available_codes`
- [x] **إصلاح شحن المحفظة**
  - تحديث `wallet_balance_jod` و `wallet_balance_usd`
- [x] **اختبار شامل - 28/28 اختبار نجح (100%)**
